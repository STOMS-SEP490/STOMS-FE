...
const columns: ColumnDef<Transaction>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const style = type === 'Đóng góp' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-600';

      return <span className={`px-3 py-1 rounded-full text-xs font-medium ${style}`}>{type}</span>;
    },
  },
  {
    accessorKey: 'amount',
