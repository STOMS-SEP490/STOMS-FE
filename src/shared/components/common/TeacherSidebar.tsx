...
import { CalendarDays, Clock, FileText, LogOut, Menu, UserCircle, ClipboardList, Wallet, CheckCircle2 } from 'lucide-react';
...
export default function TeacherSidebar() {
  ...
  const menus = useMemo(
    () => [
      ...
      { label: 'Phân công', icon: ClipboardList, path: '/teacher/timetable/assignments' },
